...
public class CategoryController {
	 ...
	 * method".
	 */
	@ApiOperation(value = "Create the category")
	 ...
	 * method
	 */
	@ApiOperation(value = "Get category of user")
	...
	public ResponseEntity<?> getAllCategoryByUserId(@PathVariable String userId) {
		...
		if (allCategory != null) {
			...
			return new ResponseEntity<String>("Error in the content Loading ", HttpStatus.CONFLICT);
		}
	}
